 ...
 */
public class CommunityViewPaperAdapter extends PagerAdapter {
    private static final String TAG = "CommunityViewPaperAdapter";
    ...
    public CommunityViewPaperAdapter(ArrayList<Map<String, Object>> viewList, FragmentManager fm) {
        mFragmentManager = fm;
