...
public class SnackContainer extends FrameLayout {
    ...
    private void showSnack(final SnackHolder holder, boolean showImmediately) {
        ...
        if (holder.snack.mActionMessage != null) {
            ...
            holder.button2.setText(holder.snack.mActionMessage2);
            holder.button2.setCompoundDrawablesWithIntrinsicBounds(holder.snack.mActionIcon, 0, 0, 0);
    ...
    public static class SnackHolder {
        ...
        private SnackHolder(Snack snack, View snackView, SnackBar.OnVisibilityChangeListener listener) {
			...
			button2=(TextView)snackView.findViewById(R.id.snackButton2);
